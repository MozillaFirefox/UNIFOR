...
INICIO
    ...
    // É atribuido o valor de a na variável aux
    aux <- a 

    // É atribuido o valor de b na variável a
    a <- b

    // É atribuido o valor de aux na variável b
    b <- aux

    //Exibe a duas mensagens concatenando os caracteres "a=","b=" as variáveis a e b respectivamente.
    ESCREVA "a=", a
    ESCREVA "b=", b
...
INICIO
    ...
    // Inicialização da variável cont  cont = 0
    cont = 0 
    ...
    // Exibe a mensagem concatenando aos caracteres "O número de alunos aprovados é: " com a variável "cont". 
...
INICIO
    ...
    // Exibe a mensagem para entrada de dados e são armazenados na variável n
    ESCREVA "Digite a quantidade de números<br> (n >= 0):"
    LEIA n

    // Executa as instruções se n >= 0
    ...
    SE n >=0 ENTAO
        ...
        ENQUANTO i <= n FAÇA
            ...
            //Exibe a mensagem com a solicitação de um número ao usuário em cada iteração
    ...
    //  Executa as instruções se a condição  "n >= 0" for falsa
    SENAO
...
INICIO
    ...
    PARA i de 0 ATÉ n-1 PASSO 1 FAÇA
        ...
        //É atribuido à variável numerador o valor de   2 * i + 1
        numerador = 2 * i + 1

        //É atribuido à variável denominador o valor de   2 * i + 2
        denominador <- 2 * i + 2

        // É atribuido à variável termo o valor de  termo = numerador / denominador

        // Incrementa a variável "S" em termo cada iteração
        S += termo

    FIM_PARA

    //  Exibe a mensagem concatenando aos caracteres "Soma da série S é " com a variável "S".   
...
INICIO
    ...
    // Entrada do usuário de um número inteiro qualquer 
    ...
    SE n >= 0 ENTAO
        ...
        PARA i DE 1 ATÉ n PASSO 1 FAÇA
            ...
            //É atribuido à variável fator o valor de fator*i
            fator <- fator * i        // fator *= i

        FIM_PARA

        // Exibe a mensagem do valor de fatorial de n
...
INICIO
    ...
    // Inicializa a variável "a" em 0 
    a <- 0

    //Inicializa a variável "b" em 1  
    b <- 1
    ...
    PARA i DE 1 ATE n PASSO 1 FAÇA
        ...
        // O valor de a + b é atribuido na variável "termo_atual"
        termo_atual <- a + b

        // O valor de b é atribuido à a
        a <- b

        // O valor de termo_atual é atribuido à b
        b <- termo_atual
...
INICIO
    ...
    SE num < 0 ENTAO
        ...
        //  Exibe a mensagem "O número deve ser positivo!"
    ...
    SENAO
        ...
        ENQUANTO num > 0 FAÇA
            ...
            // É atribuido o valor num % 10 à variável digito
            digito <- num % 10

            // É atribuido o valor (num_inv * 10) + digito à variavel num_inv
            num_inv <- (num_inv * 10) + digito

            // É atribuido o valor num // 10 à variável num
            num <- num // 10

        // Exibe a mensagem concatenando aos caracteres "Número invertido:" com a variável num_inv 
